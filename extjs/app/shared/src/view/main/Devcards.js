Ext.define('ModernTutorial.view.main.Devcards', {
    extend: 'Ext.container.Container',
    xtype: 'devcards',

    // list the classes required by this class
    requires: ['ModernTutorial.view.main.FilterForm'],
            ...
            items: [{
                ...
                items: [{
                    ...
                    html: '' +
                      ...
                      // TODO: MARIUS
                      '<iframe id="component1Frame" src="/dart/index.html" frameborder="0" width="100" height="100" onload="console.log(\'IFRAME LOADED\');document.querySelector(\'#component1Frame\').contentWindow.postMessage({component: \'component2\', sessionData: \'\', parameters: \'\', payload: \'\'})"></iframe>'
                }, {
                    bind: {
                        data: '{dev.skills}'
                    },
