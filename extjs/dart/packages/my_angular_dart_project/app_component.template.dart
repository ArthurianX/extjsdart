...
class ViewAppComponent0 extends AppView<import1.AppComponent> {
  ...
  ViewAppComponent0(AppView<dynamic> parentView, int parentIndex) : super(import4.ViewType.component, {}, parentView, parentIndex, ChangeDetectionStrategy.CheckAlways) {
    rootEl = import2.document.createElement('app-component');
    _renderType ??= import6.appViewUtils.createRenderType((import7.isDevMode ? 'asset:my_angular_dart_project/lib/app_component.dart' : null), ViewEncapsulation.None, styles$AppComponent);
  ...
  ComponentRef<import1.AppComponent> build() {
    ...
    import2.Text _text_3 = import2.Text(' This is cucu');
...
const ComponentFactory<import1.AppComponent> _AppComponentNgFactory = const ComponentFactory('app-component', viewFactory_AppComponentHost0);
